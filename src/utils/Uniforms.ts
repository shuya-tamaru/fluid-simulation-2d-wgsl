export class Uniforms {
    ...
    private init() {
        ...
        this.device.queue.writeBuffer(
            ...
            0,
            new Float32Array([
                this.color1.r, this.color1.g, this.color1.b, 1.0, 
                this.color2.r, this.color2.g, this.color2.b, 1.0, 
                this.color3.r, this.color3.g, this.color3.b, 1.0, 
                this.gridCount, this.moveStrength, 0, 0
            ])
        );
    }
